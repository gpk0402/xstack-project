...
public class TraineeController {
	...
	@PutMapping
	public ResponseEntity<TraineeProfileDto> updateTraineeProfile(@Valid @RequestBody TraineeUpdateDto traineeProfileUpdate)
	{
	...
	@PutMapping("/trainers")
	 public ResponseEntity<List<TrainerDetailsDto>> updateTraineeTrainers(@RequestParam String username ,@Valid @RequestBody List<String> trainersList)
    {
		log.info("Entered into update trainee {} trainers List {} Method RestController :{}",username,trainersList);
        return  new ResponseEntity<>(traineeServiceImpl.updateTraineeTrainersList(username,trainersList),HttpStatus.OK);   
    }
	...
	public ResponseEntity<List<TrainingDetailsDto>> getTraineeTrainings(@RequestBody TraineeTrainingsList traineeTrainingsList)
	{
