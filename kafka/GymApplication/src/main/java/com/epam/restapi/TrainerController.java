...
public class TrainerController {
	...
	@PutMapping
	public ResponseEntity<TrainerProfileDto> updateTrainerProfile(@Valid @RequestBody TrainerUpdateDto trainerProfileUpdate)
	{
	...
	public ResponseEntity<List<TrainingDetailsDto>> getTrainerTrainings(@RequestBody TrainerTrainingsList trainerTrainingsList)
	{
